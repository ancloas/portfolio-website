...
#     """Example tool that echoes input text."""
#     return f"Echo: {input_text}"

# llm_manager.register_tool(
#     name="echo_tool",
#     func=example_tool,
...
# # List tools
# print(llm_manager.list_tools())

# # Invoke a tool
# result = llm_manager.invoke_tool("echo_tool", input_text="Hello MCP!")
# print(result)

# # Call the LLM
# response = llm_manager.get_response("What is MCP?")
# print(response)